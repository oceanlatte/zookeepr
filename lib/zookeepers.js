...
function filterByQuery(query, zookeepers) {
  ...
  if (query.age) {
    filteredResults = filteredResults.filter(
      /* Data will be coming in a strings, 
      the JSON is storing age as a number.  
      The query string needs to be converted from 
      a string to a number in order to do the comparisons */
